@extends('layouts.app')
@section('title')
    Gestión de Códigos de Conciliaciones
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <h1>Gestión de Códigos de Conciliaciones</h1>
                    </div>
                </div>
            </div>
        </div>
         ...
         <div class="card">
            <div class="card-body px-0">
                <div class="d-flex justify-content-end p-3">
                    <a href="{{ route('conciliacion.create') }}" class="btn btn-primary mb-3">
                        ...
                        Nuevo Código de Conciliación</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="{{ route('conciliacion.edit', $item->id) }}" class="btn btn-sm btn-icon btn-warning"
                                        ...
                                        <form id="formDelete-{{ $item->id }}" action="{{ route('conciliacion.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
