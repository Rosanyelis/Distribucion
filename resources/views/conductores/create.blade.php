@extends('layouts.app')
@section('title')
Gestión de Conductores | Nuevo Conductor
@endsection
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form class="" method="POST" action="{{ route('conductor.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-label" for="url_file_licencia">PDF de Licencia:</label>
