@extends('layouts.app')
@section('title')
Gestión de Conductores | Editar Conductor
@endsection
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-end">
                <a href="{{ route('conductor.index') }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form class="" method="POST" action="{{ route('conductor.update', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    value="{{ $data->name }}" placeholder="Ejem: Carlos Jesus Perez Gonzalez">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="cedula" id="cedula"
                                    value="{{ $data->cedula }}" placeholder="Ejem: 236548975">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-label" for="url_file_cedula">Foto o pdf de Cedula:</label>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="licencia" id="licencia"
                                    value="{{ $data->licencia }}" placeholder="Ejem: 1235687">
                                @if ($errors->has('licencia'))
                                    <span class="text-danger">
                                        <small><em>{{ $errors->first('licencia') }}</em></small>
                                    </span>
                                @endif
                            </div>
                            <div class="form-group col-md-4">
                                <label class="form-label" for="url_file_licencia">Foto o pdf de Licencia:</label>
                                <input type="file" class="form-control" name="url_file_licencia" id="url_file_licencia">
                                @if ($errors->has('url_file_licencia'))
                                    <span class="text-danger">
                                        <small><em>{{ $errors->first('url_file_licencia') }}</em></small>
                                    </span>
                                @endif
                            </div>
                            <div class="form-group col-md-4">
                                <label class="form-label" for="fecha_ingreso">Fecha de Inicio Laboral:</label>
                                <input type="date" class="form-control" name="fecha_ingreso" id="fecha_ingreso"
                                    value="{{ $data->fecha_ingreso }}" readonly>
                                @if ($errors->has('fecha_ingreso'))
                                    <span class="text-danger">
                                        <small><em>{{ $errors->first('fecha_ingreso') }}</em></small>
                                    </span>
                                @endif
                            </div>
                            <div class="form-group col-md-4">
                                <label class="form-label" for="fecha_salida">Fecha de Salida Laboral:</label>
                                <input type="date" class="form-control" name="fecha_salida" id="fecha_salida"
                                    value="{{ $data->fecha_salida }}">
                                @if ($errors->has('fecha_salida'))
                                    <span class="text-danger">
                                        <small><em>{{ $errors->first('fecha_salida') }}</em></small>
                                    </span>
                                @endif
                            </div>
                        </div>
