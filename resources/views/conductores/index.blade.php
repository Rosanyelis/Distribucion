         ...
         <div class="card">
            <div class="card-body px-0">
                <div class="d-flex justify-content-end p-3">
                    <a href="{{ route('conductor.create') }}" class="btn btn-primary mb-3">
                                    ...
                                    <div class="flex align-items-center list-user-action">
                                        ...
                                        <div class="modal fade" id="uploadFile-{{ $item->id }}" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <form action="{{ route('conductor.uploadFiles', $item->id) }}" method="POST"
                                                        enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="uploadFile-{{ $item->id }}">Cargar archivo al conductor</h5>
                                        ...
                                        <a href="{{ route('conductor.show', $item->id) }}" class="btn btn-sm btn-icon btn-info " data-toggle="tooltip"
                                        ...
                                        <a href="{{ route('conductor.edit', $item->id) }}" class="btn btn-sm btn-icon btn-warning"
                                        ...
                                        <form id="formDelete-{{ $item->id }}" action="{{ route('conductor.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
