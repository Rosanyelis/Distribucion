        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <h1>Nuevos Datos de Distribución</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form class="" method="POST" action="{{ route('entrega.store') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="numeracion_conciliacion" class="form-control" id="">
                                    <option value="">-- Seleccione --</option>
                                    <option value="/1" @if( old('numeracion_conciliacion') == '/1' ) selected @endif >/1</option>
                                    <option value="/2" @if( old('numeracion_conciliacion') == '/2' ) selected @endif >/2</option>
                                    <option value="/3" @if( old('numeracion_conciliacion') == '/3' ) selected @endif >/3</option>
                                    <option value="/4" @if( old('numeracion_conciliacion') == '/4' ) selected @endif >/4</option>
                                    <option value="/5" @if( old('numeracion_conciliacion') == '/5' ) selected @endif >/5</option>
                                    <option value="/6" @if( old('numeracion_conciliacion') == '/6' ) selected @endif >/6</option>
                                    <option value="/7" @if( old('numeracion_conciliacion') == '/7' ) selected @endif >/7</option>
                                    <option value="/8" @if( old('numeracion_conciliacion') == '/8' ) selected @endif >/8</option>
                                    <option value="/9" @if( old('numeracion_conciliacion') == '/9' ) selected @endif >/9</option>
                                    <option value="/10" @if( old('numeracion_conciliacion') == '/10' ) selected @endif >/10</option>
                                    <option value="/11" @if( old('numeracion_conciliacion') == '/11' ) selected @endif >/11</option>
                                    <option value="/12" @if( old('numeracion_conciliacion') == '/12' ) selected @endif >/12</option>
                                    <option value="/13" @if( old('numeracion_conciliacion') == '/13' ) selected @endif >/13</option>
                                    <option value="/14" @if( old('numeracion_conciliacion') == '/14' ) selected @endif >/14</option>
                                    <option value="/15" @if( old('numeracion_conciliacion') == '/15' ) selected @endif >/15</option>
                                    <option value="/16" @if( old('numeracion_conciliacion') == '/16' ) selected @endif >/16</option>
                                    <option value="/17" @if( old('numeracion_conciliacion') == '/17' ) selected @endif >/17</option>
                                    <option value="/18" @if( old('numeracion_conciliacion') == '/18' ) selected @endif >/18</option>
                                    <option value="/19" @if( old('numeracion_conciliacion') == '/19' ) selected @endif >/19</option>
                                    <option value="/20" @if( old('numeracion_conciliacion') == '/20' ) selected @endif >/20</option>
                                    <option value="/21" @if( old('numeracion_conciliacion') == '/21' ) selected @endif >/21</option>
                                    <option value="/22" @if( old('numeracion_conciliacion') == '/22' ) selected @endif >/22</option>
                                    <option value="/23" @if( old('numeracion_conciliacion') == '/23' ) selected @endif >/23</option>
                                    <option value="/24" @if( old('numeracion_conciliacion') == '/24' ) selected @endif >/24</option>
                                    <option value="/25" @if( old('numeracion_conciliacion') == '/25' ) selected @endif >/25</option>
                                    <option value="/26" @if( old('numeracion_conciliacion') == '/26' ) selected @endif >/26</option>
                                    <option value="/27" @if( old('numeracion_conciliacion') == '/27' ) selected @endif >/27</option>
                                    <option value="/28" @if( old('numeracion_conciliacion') == '/28' ) selected @endif >/28</option>
                                    <option value="/29" @if( old('numeracion_conciliacion') == '/29' ) selected @endif >/29</option>
                                    <option value="/30" @if( old('numeracion_conciliacion') == '/30' ) selected @endif >/30</option>
                                    <option value="/31" @if( old('numeracion_conciliacion') == '/31' ) selected @endif >/31</option>
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="mes" class="form-control" id="">
                                    <option value="">-- Seleccione --</option>
                                    <option value="Enero" @if( old('mes') == 'Enero' ) selected @endif>Enero</option>
                                    <option value="Febrero" @if( old('mes') == 'Febrero' ) selected @endif>Febrero</option>
                                    <option value="Marzo" @if( old('mes') == 'Marzo' ) selected @endif>Marzo</option>
                                    <option value="Abril" @if( old('mes') == 'Abril' ) selected @endif>Abril</option>
                                    <option value="Mayo" @if( old('mes') == 'Mayo' ) selected @endif>Mayo</option>
                                    <option value="Junio" @if( old('mes') == 'Junio' ) selected @endif>Junio</option>
                                    <option value="Julio" @if( old('mes') == 'Julio' ) selected @endif>Julio</option>
                                    <option value="Agosto" @if( old('mes') == 'Agosto' ) selected @endif>Agosto</option>
                                    <option value="Septiembre" @if( old('mes') == 'Septiembre' ) selected @endif>Septiembre</option>
                                    <option value="Octubre" @if( old('mes') == 'Octubre' ) selected @endif>Octubre</option>
                                    <option value="Noviembre"  @if( old('mes') == 'Noviembre' ) selected @endif>Noviembre</option>
                                    <option value="Diciembre" @if( old('mes') == 'Diciembre' ) selected @endif>Diciembre</option>
                                </select>
                                @if ($errors->has('mes'))
                                    <span class="text-danger">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="propietario_id" class="form-control" id="">
                                    ...
                                    @foreach ($propietarios as $item)
                                        <option value="{{ $item->id }}" @if( old('propietario_id') == $item->id ) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="tracto_camion_id" class="form-control" id="">
                                    ...
                                    @foreach ($tractocamiones as $item)
                                        <option value="{{ $item->id }}" @if( old('tracto_camion_id') == $item->id ) selected @endif>{{$item->propietario->name}} - {{ $item->placa }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="tramo_id" class="form-control" id="">
                                    ...
                                    @foreach ($tramos as $item)
                                        <option value="{{ $item->id }}" @if( old('tramo_id') == $item->id ) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="tolerance_percentage" id="tolerance_percentage"
                                    value="{{ old('tolerance_percentage') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="carguio" id="carguio"
                                    value="{{ old('carguio') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="volumen_descarguio" id="volumen_descarguio"
                                    value="{{ old('volumen_descarguio') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="merma" id="merma"
                                    value="{{ old('merma') }}" readonly>
                                @if ($errors->has('merma'))
                                    <span class="text-danger">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="cobros_merma" id="cobros_merma"
                                    value="{{ old('cobros_merma') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="merma_permisible" id="merma_permisible"
                                    value="{{ old('merma_permisible') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="merma_limite_excedible" id="merma_limite_excedible"
                                    value="{{ old('merma_limite_excedible') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="merma_cobrable" id="merma_cobrable"
                                    value="{{ old('merma_cobrable') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="precio_merma" id="precio_merma"
                                    value="{{ old('precio_merma') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="merma_por_cobrar" id="merma_por_cobrar"
                                    value="{{ old('merma_por_cobrar') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="flete" id="flete"
                                    value="{{ old('flete') }}">
                                @if ($errors->has('flete'))
                                    <span class="text-danger">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="liquido_basico" id="liquido_basico"
                                    value="{{ old('liquido_basico') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="derecho_empresa_porcentaje" id="derecho_empresa_porcentaje"
                                    value="{{ old('derecho_empresa_porcentaje') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="derecho_empresa" id="derecho_empresa"
                                    value="{{ old('derecho_empresa') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="liquido_facturado" id="liquido_facturado"
                                    value="{{ old('liquido_facturado') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="retenciones" id="retenciones"
                                    value="{{ old('retenciones') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="liquido_pagable" id="liquido_pagable"
                                    value="{{ old('liquido_pagable') }}" readonly>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="total_anticipos" id="total_anticipos"
                                    value="{{ old('total_anticipos') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="total" id="total"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="total_deuda" id="total_deuda"
                                    value="{{ old('total_deuda') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="factura_n" id="factura_n"
                                    value="{{ old('factura_n') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" patern="[0-9]*$" class="form-control" name="factura_apoyo" id="factura_apoyo"
                                    value="{{ old('factura_apoyo') }}">
