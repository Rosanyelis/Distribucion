                    ...
                    <form class="" method="POST" action="{{ route('product.store') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="form-label" for="uname">Combustible:</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="tolerance_percentage" id="tolerance_percentage"
                                    value="{{ old('tolerance_percentage') }}" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="adminisible" id="adminisible"
                                    value="{{ old('adminisible') }}" >
