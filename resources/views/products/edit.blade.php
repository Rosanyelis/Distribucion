        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-product-info">
                    <form class="" method="POST" action="{{ route('product.update', $data->id) }}">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="form-label" for="name">Combustible:</label>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="tolerance_percentage">Porcentaje de Tolerancia (%):</label>
                                <input type="text" class="form-control" name="tolerance_percentage" id="tolerance_percentage"
                                    value="{{ $data->tolerance_percentage }}" >
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="adminisible">Adminisible:</label>
                                <input type="text" class="form-control" name="adminisible" id="adminisible"
                                    value="{{ $data->adminisible }}">
                                @if ($errors->has('adminisible'))
                                    <span class="text-danger">
                                        <small><em>{{ $errors->first('adminisible') }}</em></small>
                                    </span>
                                @endif
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-label" for="price">Precio:</label>
                                <input type="price" class="form-control" name="price" id="pass" value="{{ $data->price }}">
                                @if ($errors->has('price'))
                                    <span class="text-danger">
