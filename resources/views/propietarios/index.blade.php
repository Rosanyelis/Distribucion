         ...
         <div class="card">
            <div class="card-body px-0">
                <div class="d-flex justify-content-end p-3">
                    <a href="{{ route('propietario.create') }}" class="btn btn-primary mb-3">
                                    ...
                                    <div class="flex align-items-center list-user-action">
                                        ...
                                        <div class="modal fade" id="uploadFile-{{ $item->id }}" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <form action="{{ route('propietario.uploadFiles', $item->id) }}" method="POST"
                                                        enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="uploadFile-{{ $item->id }}">Cargar archivo al propietario</h5>
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip"
                                            data-placement="top" title="Agregar Cuenta Bancaria" data-original-title="Ver"
                                            data-bs-toggle="modal" data-bs-target="#addCuenta-{{ $item->id }}">
                                            <span class="btn-inner">
                                                <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="modal fade" id="addCuenta-{{ $item->id }}" data-bs-backdrop="static"
                                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="addCuenta-{{ $item->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <form action="{{ route('propietario.addCuentaBancaria', $item->id) }}" method="POST"
                                                        enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addCuenta-{{ $item->id }}">Agregar Cuenta Bancaria al propietario</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body row">
                                        ...
                                        <a href="{{ route('propietario.show', $item->id) }}" class="btn btn-sm btn-icon btn-info " data-toggle="tooltip"
                                        ...
                                        <a href="{{ route('propietario.edit', $item->id) }}" class="btn btn-sm btn-icon btn-warning"
