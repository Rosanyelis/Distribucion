@extends('layouts.app')
@section('title')
    Gestión de Tracto Caminones - Crear Tracto Camión
@endsection
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form class="" method="POST" action="{{ route('tracto-camiones.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="tipo_vehiculo" id="tipo_vehiculo" class="form-control">
                                    ...
                                    <option value="Camion" {{ old('tipo_vehiculo') == 'Camion' ? 'selected' : '' }}>Camion</option>
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="tipo_carroceria" id="tipo_carroceria" class="form-control">
                                    <option value="">-- Seleccione --</option>
                                    <option value="Sedan" @if (old('tipo_carroceria') == 'Sedan') selected @endif >Sedan</option>
                                    <option value="SUV" @if (old('tipo_carroceria') == 'SUV') selected @endif>SUV</option>
                                    <option value="Minivan" @if (old('tipo_carroceria') == 'Minivan') selected @endif>Minivan</option>
                                    <option value="Pickup" @if (old('tipo_carroceria') == 'Pickup') selected @endif>Pickup</option>
                                    <option value="Hatchback" @if (old('tipo_carroceria') == 'Hatchback') selected @endif>Hatchback</option>
                                    <option value="Coupe" @if (old('tipo_carroceria') == 'Coupe') selected @endif>Coupe</option>
                                    <option value="Convertible" @if (old('tipo_carroceria') == 'Convertible') selected @endif>Convertible</option>
                                    <option value="Crossover" @if (old('tipo_carroceria') == 'Crossover') selected @endif>Crossover</option>
                                    <option value="Truck" @if (old('tipo_carroceria') == 'Truck') selected @endif>Truck</option>
                                    <option value="Van" @if (old('tipo_carroceria') == 'Van') selected @endif>Van</option>
                                    <option value="Bus" @if (old('tipo_carroceria') == 'Bus') selected @endif>Bus</option>
                                    <option value="Trailer" @if (old('tipo_carroceria') == 'Trailer') selected @endif>Trailer</option>
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" name="capacidad_total" id="capacidad_total"
                                    value="{{ old('capacidad_total') }}" placeholder="">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" name="capacidad_compartimiento1" id="capacidad_compartimiento1"
                                    value="{{ old('capacidad_compartimiento1') }}" placeholder="">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" name="capacidad_compartimiento2" id="capacidad_compartimiento2"
                                    value="{{ old('capacidad_compartimiento2') }}" placeholder="">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" name="fechai_tarjeta_operacion" id="fechai_tarjeta_operacion"
                                    value="{{ old('fechai_tarjeta_operacion') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" name="fechaf_tarjeta_operacion" id="fechaf_tarjeta_operacion"
                                    value="{{ old('fechaf_tarjeta_operacion') }}">
