         ...
         <div class="card">
            <div class="card-body px-0">
                <div class="d-flex justify-content-end p-3">
                    <a href="{{ route('tramo.create') }}" class="btn btn-primary mb-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="{{ route('tramo.edit', $item->id) }}" class="btn btn-sm btn-icon btn-warning"
                                        ...
                                        <form id="formDelete-{{ $item->id }}" action="{{ route('tramo.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
